<html>
    <head>
        ...
        <link type='text/css' rel='stylesheet' href='<%=request.getContextPath()%>/jeferson/css/tabelas.css'>
    </head>
    <body>
       <div class='tabelaGC'>
            ...
            <form action='<%=request.getContextPath()%>/CadastroClienteJefersonFinaliza' method='post'>
                <fieldset>
