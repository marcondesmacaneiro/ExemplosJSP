...
<html>
    <head>
        ...
        <link type='text/css' rel='stylesheet' href='<%=request.getContextPath()%>/silvana/css/tabelas.css'>
    </head>
    <body>
        ...
        <div class='tabelaGC'>
            ...
            <form action='<%=request.getContextPath()%>/CadastroClientesilvana' method='post'>
                ...
                <fieldset>
                    ...
                    <input type='image' src='<%=request.getContextPath()%>/silvana/images/salvar.gif'>
                </fieldset>
            </form>
        </div>    
    </body>
