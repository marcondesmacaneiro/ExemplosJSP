<html>
    ...
    <body>
       <div class='tabelaGC'>
            ...
            <form action='<%=request.getContextPath()%>/CadastroClienteViniciusSeboldFinalizar' method='post'>
                <fieldset>
                    ...
                    <input type='image' src='<%=request.getContextPath()%>/viniciussebold/images/salvar.gif'>
                </fieldset>
            </form>
        </div>                        
    </body>
