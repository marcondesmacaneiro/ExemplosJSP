<html>
    <head>
        ...
        <link type='text/css' rel='stylesheet' href='<%=request.getContextPath()%>/jorge/css/tabelas.css'>
    </head>
    <body>
       <div class='tabelaGC'>
            ...
            <form action='<%=request.getContextPath()%>/CadastroClienteJorgeFinaliza' method='post'>
                <fieldset>
