<%-- 
    ...
    Created on : 13/06/2013, 20:09:19
    Author     : diego
--%>
...
<%
    try {
        ...
        Connection conect = DriverManager.getConnection("jdbc:mysql://localhost:3306/aw", "root", "");
...
<script>
    ...
    { 
        ...
        $.ajax({
            url : "<%=request.getContextPath()%>/Altera_Remove",
            type : 'GET',
            dataType: "json",
            data : { req:"1",
                cliente:id_cliente,
...
<html>
    <head>
        ...
        <title>Lista e Exclui</title>
        <link type='text/css' rel='stylesheet' href='<%=request.getContextPath()%>/diego/tabelas.css'>
                ...
                <td>
                    <div class='tabelaGC'> 
                        ...
                        <fieldset>
                            ...
                            <table border='0' id="<%=resultado.getString("id")%>">
                                <tr>
