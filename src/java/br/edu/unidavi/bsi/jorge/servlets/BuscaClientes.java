...
public class BuscaClientes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        /* Seta o parametro "listaclientes" para buscar uma lista de clientes para mandar pro proximo parametro
         manutenção declientes para mostrar para o usuario*/
        /* Cria uma lista de valor nulo, e vai citar a lista como getall para pegar todos osdados que estão
         cadastrados, e retorna em forma de lista*/
        List lista = null;
        try{
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/jorge/manutencaoClientes.jsp");
