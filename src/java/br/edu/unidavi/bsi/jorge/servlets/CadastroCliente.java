 ...
 * @author Jorge
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteJorgeFinaliza"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/jorge/clienteCompleto.jsp");
