...
public class AlterarCliente extends HttpServlet {
    ...
    /*parametro pega os dados digitados e armazenadas nas variaveis, o request criar um parametro "Cliente"
     já citando esses dados, e depois da um comando para salvar os dados no "Cliente" */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            mensagem = "Não foi possível alterar o cliente selecionado";
        }
        
        request.setAttribute("mensagem", mensagem);
        /* Ele manda o parametro para buscarclientes para o sistema realizar novamente uma busca e atualizar
         a lista e depois o busca clientes mostra novamente a lista de usuarios*/
