...
import br.edu.unidavi.bsi.viniciussebold.exception.UnidaviBsiException;
import br.edu.unidavi.bsi.viniciussebold.jdbc.ClienteDAO;
import br.edu.unidavi.bsi.viniciussebold.model.Cliente;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteViniciusSeboldFinalizar"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException, UnidaviBsiException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/viniciussebold/clienteCompleto.jsp");
