 ...
 * @author marcondes
 */
@WebServlet(name = "LeDados", urlPatterns = {"/DigitarEndereçoClienteViniciusSebold"})
public class LeDados extends HttpServlet {
    ...
    throws ServletException, IOException {
         ...
         */
        RequestDispatcher dispatcher = request.getRequestDispatcher("/viniciussebold/enderecoCliente.jsp");
