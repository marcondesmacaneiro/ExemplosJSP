 ...
 */
package br.edu.unidavi.bsi.michel.servlets;

import br.edu.unidavi.bsi.michel.exception.UnidaviBsiException;
import br.edu.unidavi.bsi.michel.jdbc.ClienteDAO;
import br.edu.unidavi.bsi.michel.model.Cliente;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteMichel"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/michel/clienteCompleto.jsp");
