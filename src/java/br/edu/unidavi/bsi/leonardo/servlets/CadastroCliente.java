...
import br.edu.unidavi.bsi.leonardo.jdbc.ClienteDAO;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteLeonardoFinaliza"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException, UnidaviBsiException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/leonardo/clienteCompleto.jsp");
