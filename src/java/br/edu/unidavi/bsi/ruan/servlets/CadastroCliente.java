 ...
 */
package br.edu.unidavi.bsi.ruan.servlets;

import br.edu.unidavi.bsi.ruan.exception.UnidaviBsiException;
import br.edu.unidavi.bsi.ruan.jdbc.ClienteDAO;
import br.edu.unidavi.bsi.ruan.model.Cliente;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/EndClienteRuan"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/ruan/clienteCompleto.jsp");
