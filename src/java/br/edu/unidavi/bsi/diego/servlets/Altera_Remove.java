...
import br.edu.unidavi.bsi.diego.locator.ServiceLocator;
 ...
 * @author Leo
 */
@WebServlet(name = "Altera_Remove", urlPatterns = {"/Altera_Remove"})
public class Altera_Remove extends HttpServlet {
