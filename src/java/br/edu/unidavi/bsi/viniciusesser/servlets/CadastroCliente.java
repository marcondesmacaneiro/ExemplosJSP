...
import br.edu.unidavi.bsi.viniciusesser.jdbc.ClienteDAO;
import br.edu.unidavi.bsi.viniciusesser.model.Cliente;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteViniciusEsserFinaliza"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException, UnidaviBsiException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("viniciusesser/clienteCompleto.jsp");
