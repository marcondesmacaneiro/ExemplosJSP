 ...
 * @author marcondes
 */
@WebServlet(name = "LeDados", urlPatterns = {"/DigitarEnderecoClienteViniciusEsser"})
public class LeDados extends HttpServlet {
    ...
    throws ServletException, IOException {
         ...
         */
        RequestDispatcher dispatcher = request.getRequestDispatcher("/viniciusesser/enderecoCliente.jsp");
