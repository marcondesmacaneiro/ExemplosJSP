package br.edu.unidavi.bsi.gustavo.jdbc;
...
public class ClienteDAO extends BaseDAO {
    ...
    private static String SQL_INSERT_CLIENTE =
            "insert into aw.clientes ( nome, email, senha, telefone, endereco_rua, endereco_numero, endereco_bairro, endereco_cep, " +
            "endereco_cidade, endereco_estado, ativo ) " +
            "values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";
    
    private static String SQL_UPDATE_CLIENTE =
            "update aw.clientes set nome = ?, email = ?, senha = ?, telefone = ?, endereco_rua = ?, endereco_numero = ?, " +
