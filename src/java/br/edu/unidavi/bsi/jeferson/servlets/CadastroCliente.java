 ...
 */
package br.edu.unidavi.bsi.jeferson.servlets;

import br.edu.unidavi.bsi.jeferson.exeption.UnidaviBsiException;
import br.edu.unidavi.bsi.jeferson.jdbc.ClienteDAO;
import br.edu.unidavi.bsi.jeferson.model.Cliente;
 ...
 * @author marcondes
 */
@WebServlet(name = "CadastroCliente", urlPatterns = {"/CadastroClienteJefersonFinaliza"})
public class CadastroCliente extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/jeferson/clienteCompleto.jsp");
